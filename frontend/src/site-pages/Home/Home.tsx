    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            gsap.utils.toArray<HTMLElement>(`.${styles.reveal}`).forEach((el) => {
                gsap.fromTo(el,
                    { opacity: 0, y: 40 },
                    { opacity: 1, y: 0, duration: 0.9, ease: 'power3.out', scrollTrigger: { trigger: el, start: 'top 90%', toggleActions: 'play none none none' } }
                );
            });
            ...
            <div ref={rootRef} style={{ position: 'relative', overflow: 'hidden' }}>
                ...
                <section className={`${styles.statsSection} section-inset`}>
                    <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                        ...
                        <p className={`${styles.statsQuote} ${styles.reveal}`}>
                    ...
                    <div className="container">
                        <div className={`${styles.sectionHeader} reveal`}>
                            <div>
                                ...
                                <h2 className="section-title">Systems we engineer</h2>
                            </div>
                    ...
                    <div className="container">
                        <div className={`${styles.sectionHeader} reveal`}>
                            <div>
                                ...
                                <h2 className="section-title">Why TrenchLabs</h2>
                            </div>
                        </div>
                    ...
                    <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                        <div className={`${styles.sectionHeader} reveal`}>
                            <div>
                                ...
                                <h2 className="section-title">From idea to shipped system</h2>
                            </div>
                        </div>
